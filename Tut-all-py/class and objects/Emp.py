...
that the first argument to each method is self. Python adds the self argument to the list for you; you do not need to
include it when you call the methods.


""")

print("Creating Instance Objects")

"This would create first object of Employee class"
emp1 = Employee("Gaganjeet", 2000)
"This would create second object of Employee class"
emp2 = Employee("Neha", 5000)
