...
print("""Lists are the most versatile of Python's compound data types.
...
slice operator ([ ] and [:]) with indexes starting at 0 in the beginning of
the list and working their way to end -1. The plus (+) sign is the list
